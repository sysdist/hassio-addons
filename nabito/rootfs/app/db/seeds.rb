...
Connector.create!([
  {name: 'sonoff1', 
    ...
    voltage: 230, i_max: '16.0', price_per_kWh: '0.1', frequency: 60, state: 'unknown', 
    current_user: nil, current_tnx: nil, user_id: 1, current_kWh: '10.291', shadow_state: 'off',
    last_timestamp: '2019-07-17 11:08:22' }
])
